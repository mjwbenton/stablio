...
class StablioStack extends TerraformStack {
  constructor(scope: Construct, id: string) {
    ...
    const emailBucket = new aws.s3Bucket.S3Bucket(this, "EmailBucket", {
      bucketPrefix: "stablio-email-bucket"
    });
    this.createEmailRule(emailBucket);
  }
